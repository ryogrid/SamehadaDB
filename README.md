...
# Motivation
- RDBMS implementation which is simple but has almost of essential componets and features as near productinal one is needed for newbie of database system developer
