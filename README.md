...
# Motivation
- RDBMS implementation which is simple but has almost of fundamental componets and functinality is needed for newbie of database system development domain
