...
type LogRecovery struct{
	DiskManager *disk_manager //__attribute__((__unused__))
	BufferPoolManager *buffer_pool_manager //__attribute__((__unused__))
	...
	std::unordered_map<lsn_t, int> lsn_mapping
 ...
 */
func bool (log_recovery *LogRecovery) DeserializeLogRecord(const char *data, LogRecord *log_record) {
