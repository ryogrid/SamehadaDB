...
func TestAggFuncSelectQuery(t *testing.T) {
	...
	testingpkg.SimpleAssert(t, queryInfo.SelectFields[0].AggType == plans.CountAggregate)
	testingpkg.SimpleAssert(t, *queryInfo.SelectFields[0].ColName == "*")
	testingpkg.SimpleAssert(t, queryInfo.SelectFields[1].IsAgg == true)
	testingpkg.SimpleAssert(t, queryInfo.SelectFields[1].AggType == plans.MaxAggregate)
	testingpkg.SimpleAssert(t, *queryInfo.SelectFields[1].ColName == "b")
	testingpkg.SimpleAssert(t, queryInfo.SelectFields[2].IsAgg == true)
	testingpkg.SimpleAssert(t, queryInfo.SelectFields[2].AggType == plans.MinAggregate)
	...
	testingpkg.SimpleAssert(t, queryInfo.SelectFields[3].AggType == plans.SumAggregate)
